...
function Footer() {
    return (
        <Box sx={{ paddingTop: "50px", backgroundImage: "url(https://barista.qodeinteractive.com/elementor/wp-content/uploads/2017/02/footer-img.jpg)", marginTop:"30px" }}>
            <Container sx={{ color: "white", textTransform: "uppercase", fontWeight: "600", fontSize: { xs: "20px", sm: "23px" }, margin: "auto" }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={3}>
                        ...
                        <Typography sx={{ marginTop: "30px", fontSize: "14px", textTransform: "lowercase" }}>antilia@gmail.com</Typography>
                    ...
                    <Grid item xs={12} md={3}>
                        ...
                        {['Antilia parke '].map((location, index) => (
                            <Box key={index} sx={{ marginTop: "30px" }}>
