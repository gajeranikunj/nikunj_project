...
function RESERVATION() {
    ...
    return (
        <>
            <Nav />
            <Fastsection
                url={"https://cdn.pixabay.com/video/2024/03/21/205006-926015709_large.mp4"}
                name={"RESERVATION"}
            />
            <Container>
                <Box>
                    <Grid container sx={{ marginTop: "60px" }}>
                        ...
                        <Grid item lg={6}>
                            ...
                            }} component={'img'} src='https://restaurant.eatapp.co/hubfs/WordPress-Table-Reservation-plugin-1000x562-1.webp ' data-aos="fade-left" data-aos-delay="300"></Box>
                        </Grid>
                    </Grid>
                </Box>
                <Container>
